...
const switchAccountConfig: Record<string, RoleId[]> = {
  'localhost:3001': [RoleId.TEACHER, RoleId.TEAM_LEADER],
  'dev-lmp.prathamdigital.org': [RoleId.TEACHER, RoleId.TEAM_LEADER],
  'qa-lmp.prathamdigital.org': [RoleId.TEACHER, RoleId.TEAM_LEADER],
  'lmp.prathamdigital.org': [RoleId.TEACHER, RoleId.TEAM_LEADER],
  'localhost:3002': [
    RoleId.ADMIN,
    RoleId.CENTRAL_LEAD,
    RoleId.SCTA,
