...
const AboutUsPage = () => {
  ...
  const descriptions = [
    [
      ...
      'School description line 1.',
      'School description line 2.',
      'School description line 3.',
    ],
    [
      {
        cardDesc:
    ...
    [
      ...
      'Life description line 1.',
      'Life description line 2.',
      'Life description line 3.',
    ],
  ];
  return (
    <Layout>
