        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                Pratham Education Foundation ("Pratham", "we", "our", "us") is
                one of the largest non-governmental organisations (NGOs) working
                to improve the quality of education in India. Started with the
                ...
                & Learning Well". These terms and conditions sets out to explain
                and govern the terms for usage of our website w.r.t content that
                is provided to you by us through this website. Please read these
                terms and conditions carefully before using this website. These
                terms and conditions apply to all visitors, users and others who
                wish to access our website ("you", "yours", "user"). By
                accessing or using or browsing our website through any means
                shall signify your acceptance of the terms and conditions and
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                intellectual property rights remain with us. You must not
                modify, tweak, edit or use the Materials for any other purpose
                without our written consent. By using and/or downloading any
                Materials from our website, you will be deemed to have agreed to
                the following terms:
              </Typography>
              ...
              <Box sx={{ ml: { xs: 2, md: 3 }, mb: 2 }}>
                ...
                >
                  ...
                  this list does not constitute a waiver of PRATHAM's trademark
                  or other intellectual property rights concerning that name or
                  logo or product. All other company names/logos/trademarks
                  mentioned in our website may be trademarks of their respective
                  owners. Use of Pratham Marks for commercial purposes is
                  strictly prohibited.
                </Typography>
              </Box>
              ...
              <Box sx={{ ml: { xs: 2, md: 3 }, mb: 2 }}>
                ...
                >
                  ...
                  used for non-commercial purposes. Upon receiving consent from
                  us for usage, you must give appropriate credit to Pratham and
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                therefore requested to verify this information before you act
                upon it. By accessing this website, you agree that we will not
                be liable for any mistake, omission, inaccuracy, typographical
                errors, direct or indirect loss arising from the use of
                information and material contained in the website. We make no
                warranty that the contents of the website are free from
                infection by virus or any malicious code which has contaminating
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                these terms and conditions at any time by updating these terms
                and conditions on our website. Please remember to visit this
                page from time to time to review any amendments to the above
                terms and conditions.
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                or reliability of linked websites and does not necessarily
                endorse the view expressed within them. We cannot guarantee the
                availability of such linked pages. We cannot guarantee that
              ...
              >
                <strong>Links to Our Website by other Websites:</strong> We do
                not object to you linking directly to the information that is
                hosted on our website and no prior permission is required for
                the same. Additionally, we do not allow your website to load our
                pages in frames. Our website's pages need to load in the window
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                Wherever the Website requests you to provide personal
                information, you will be informed for the particular purposes
                for which the information is gathered and adequate security
                measures will be taken to protect your personal information. For
                deletion of your information, you may raise a request to{' '}
                <a
                ...
                be protected from loss, misuse, unauthorized access or
                disclosure, alteration, or destruction. We gather certain
                information about the User, such as Internet protocol (IP)
                addresses, domain name, browser type, operating system, the date
                and time of the visit and the pages visited. We make no attempt
                to link these addresses with the identity of individuals
                visiting our site unless an attempt to damage the site has been
                detected. If you come across any personally identifiable
                information while viewing the material available on our website,
                you shall comply with the Digital Personal Data Protection Act,
                2023 and shall not use, download or share such information
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                accordance with the terms and conditions and agree not to use
                our website for the following purposes:
              </Typography>
              <Box component="ol" sx={{ pl: 3, mb: 2 }}>
                ...
                <li>
                  ...
                  >
                    For the purpose of exploiting, hurting, or attempting to
                    abuse any party (company, individual or minor) in any
                    manner.
                  </Typography>
                </li>
                <li>
                  ...
                  >
                    ...
                    website and not use or share such material for any
                    commercial purposes.
                  </Typography>
                </li>
                <li>
                ...
                <li>
                  ...
                  >
                    ...
                    any way directly or in connection with is illegal,
                ...
                <li>
                  ...
                  >
                    ...
                    or offend us or users of this website or expose them to
                    liability.
                  </Typography>
                </li>
                <li>
                ...
                <li>
                  ...
                  >
                    ...
                    otherwise disassemble any part of the website or any
                    software utilised on it;
                  </Typography>
                </li>
                <li>
                  <Typography
                ...
                <li>
                  ...
                  >
                    Take any action that may damage or falsify our
                    rating/reviews.
                  </Typography>
                </li>
                <li>
                ...
                <li>
                  ...
                  >
                    ...
                    imply or state that any statements you make are supported by
                    us.
                  </Typography>
                </li>
              </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                terms and conditions shall be subject to exclusive jurisdiction
                of Courts of Mumbai, India.
              </Typography>
            </Box>
