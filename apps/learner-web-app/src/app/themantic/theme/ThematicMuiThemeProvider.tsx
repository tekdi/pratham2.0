...
export const thematicTheme = createTheme({
  typography: {
...
export default function ThematicMuiThemeProvider({
  children,
}: {
  ...
  return (
    <ColorInversionProvider>
      <FontSizeTheme baseTheme={thematicTheme}>
        <CssBaseline />
...
export const ThematicMuiThemeProviderWithLanguage = ({
  children,
}: {
  children: React.ReactNode;
}) => {
