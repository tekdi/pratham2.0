...
const Content = dynamic(() => import('@content-mfes/components/Content/CommonList'), {
    ssr: false,
  });
...
export default memo(function LearnerCourse({
  ...
  // Get framework from localStorage
  const getFrameworkFromStorage = () => {
    if (typeof window !== 'undefined') {
      return localStorage.getItem('collectionFramework') || 'pos-framework';
    }
