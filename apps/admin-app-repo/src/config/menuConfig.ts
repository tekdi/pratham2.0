...
const SECOND_CHANCE_PROGRAM_MENU = {
  centers: {
...
export const MENU_CONFIG = {
  [TenantName.SECOND_CHANCE_PROGRAM]: SECOND_CHANCE_PROGRAM_MENU,
  [TenantName.SECOND_CHANCE_PROGRAM_PATHWAYS]: SECOND_CHANCE_PROGRAM_MENU,
  [TenantName.YOUTHNET]: {
    centers: {
