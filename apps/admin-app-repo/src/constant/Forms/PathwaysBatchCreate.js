export const PathwaysBatchCreateSchema = {
  type: 'object',
  properties: {
    board: {
      type: 'array',
    ...
    stream: {
      ...
      title: 'STREAM',
      coreField: 0,
      fieldId: '1d65cb1e-9552-47d3-83e4-33edd9bd16c8',
      field_type: 'drop_down',
      maxSelection: 50,
      isMultiSelect: true,
      uniqueItems: true,
  ...
  required: ['board', 'medium', 'grade', 'stream', 'name', 'batch_type'],
};

export const PathwaysBatchCreateUISchema = {
  'ui:order': ['name', 'batch_type', 'board', 'medium', 'grade', 'stream'],
  board: {
