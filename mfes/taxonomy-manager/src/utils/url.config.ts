export const URL_CONFIG = {
  API: {
    ...
    CHANNEL_CREATE: `${process.env.NEXT_PUBLIC_MIDDLEWARE_URL}/api/channel/v1/create`,
    FRAMEWORK_READ: `${process.env.NEXT_PUBLIC_MIDDLEWARE_URL}/api/framework/v1/read`,
    ...
    MASTER_CATEGORY_SEARCH: `${process.env.NEXT_PUBLIC_MIDDLEWARE_URL}/action/composite/v3/search`,
    MASTER_CATEGORY_CREATE: `${process.env.NEXT_PUBLIC_MIDDLEWARE_URL}/api/framework/v1/category/master/create`,
